...
- 서울환경연합 홈페이지, 서울시공익활동지원센터, SNS, 블로그 등 비언론사 출처는 수집 대상에서 제외
- 같은 언론사 안의 같은 기사만 중복 의심 처리
- 관리자 비밀번호 로그인 / 보기 전용 공유 링크
- 사업계획서 Google Docs 링크, PDF, DOCX 업로드
- 사업계획서 사업명 발췌와 사업별 기사 분류
- 사업 목록 활성화, 비활성화 관리
- 사업 목록 분류 수정과 연결 기사 팀명 동시 반영
- 캠페인명 검색어 자동 생성
- 검색어 추가, 활성화, 비활성화
- 기사 후보 수동 수집
- 사업 목록 수동 추가
- 관리자 확인값 즉시 저장과 자동 수집 시 보존
- 지정 검색어 단독 검색 후 사업 매칭
- 네이버뉴스 정확도순 정확 일치 검색 우선 수집
- Google News RSS, 네이버뉴스 직접 검색, 네이버/다음 뉴스 제한 검색 보강
- 조직명+캠페인명 조합 검색은 누락 보강용으로 사용
- 기사 수동 추가
- 관련성 자동판정과 기사 품질 자동 추천
- 팀명/사업명 필터, 사업 분류, 기사 품질, 대표 기사, 검토 상태 보정
- 출처 검색, 출처 다중 선택, 주요 언론사만 보기
- 기사 목록 25건 단위 페이지 이동
- 확인이 필요한 검토/사업/품질 항목 우선 노출, 노란색 강조, 상단 확인 필요 수 일치
- 출처/일시 분리와 일시 최신순·오래된순 정렬
- 키워드 근거 기사 수 많은 순 정렬
- AI 판정 근거를 기사 제목 하단 태그로 요약 표시
- 기사 수동 수집 진행 상태창과 중복 실행 방지
- 고유 캠페인명은 해당 사업으로, 넓은 정책 이슈는 정책 대응 사업으로 우선 매칭
...
| 보도 횟수 기준 | 검토 상태가 `관련`인 언론사 기사 자동 포함 |
